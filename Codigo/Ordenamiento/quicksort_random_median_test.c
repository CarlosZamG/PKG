...
//       gcc quicksort.c quicksort_random_median_test.c -o quicksort_random_median_test.out
// Command to run the program:
//      ./quicksort_random_median_test.out
...
int main()
{
    ...
    printf("\n");
    quicksort_random_median(array, size);
    for (int i = 0; i < size; i++)
    {
        printf("%d ", array[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array2, size2);
    for (int i = 0; i < size2; i++)
    {
        printf("%d ", array2[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array3, size3);
    for (int i = 0; i < size3; i++)
    {
        printf("%d ", array3[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array4, size4);
    for (int i = 0; i < size4; i++)
    {
        printf("%d ", array4[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array5, size5);
    for (int i = 0; i < size5; i++)
    {
        printf("%d ", array5[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array6, size6);
    for (int i = 0; i < size6; i++)
    {
        printf("%d ", array6[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array7, size7);
    for (int i = 0; i < size7; i++)
    {
        printf("%d ", array7[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array8, size8);
    for (int i = 0; i < size8; i++)
    {
        printf("%d ", array8[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array9, size9);
    for (int i = 0; i < size9; i++)
    {
        printf("%d ", array9[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array10, size10);
    for (int i = 0; i < size10; i++)
    {
        printf("%d ", array10[i]);
    }
    ...
    printf("\n");
    quicksort_random_median(array11, size11);
    for (int i = 0; i < size11; i++)
    {
        printf("%d ", array11[i]);
    }
